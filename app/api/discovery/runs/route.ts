...
export async function POST(req: Request) {
  try {
    ...
    // Build canonical Meta Ad Library country search URL with exact requested filters (zero-joiner query, Arabic language, Facebook & Instagram, total_impressions desc)
    const searchUrl =
