    ...
    <div className="max-w-3xl mx-auto">
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center space-y-4">
          ...
          {file && (
            <div className="inline-flex items-center space-x-2 bg-slate-900 px-4 py-2 rounded-lg border border-slate-800 text-xs text-slate-200">
        ...
        <div className="mt-8 glass-card rounded-2xl p-6 border border-slate-800">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-amber-500/10 p-3.5 rounded-xl border border-amber-500/20">
              <div className="text-xs text-amber-400">Duplicates Removed</div>
            ...
            <div className="bg-rose-500/10 p-3.5 rounded-xl border border-rose-500/20">
              <div className="text-xs text-rose-400">Invalid / Failed</div>
                ...
                <div className="flex-1">
                  ...
                  {!confirmed ? (
                    <button
                      ...
                      disabled={confirming}
                      className="mt-4 flex items-center space-x-2 bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold text-xs px-5 py-2.5 rounded-lg shadow-md transition-all cursor-pointer disabled:opacity-50"
                    >
                      {confirming ? (
